...
use App\Http\Requests\Api\Register\RefineryRequest;
 ...
 */
class RefineryRegister extends Controller
{
    public function register(RefineryRequest $request){
        ...
        try{
            ...
            $refinery = Refinery::create($new_data);
